...
const useStyles = makeStyles((theme: Theme) => createStyles({
    main: {
        ...
        backgroundImage: `linear-gradient(rgba(26,121,9,100), rgba(116, 9, 121, 100))`,
        width: '100%',
        height: '100%',
        position: 'absolute',
...
export const BeerFavorites = withRouter(( props:BeerProps ) => {
    console.log(props);
    const { history } = props;
        ...
        <div className={`${classes.root} ${classes.column}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}> {/* We are using MUI to make another navbar */}
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Beer</Button>
